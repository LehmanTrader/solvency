...
**Not in either table:** the remaining 292 priced, current models in the catalog — which,
...
- **292 of 387 current, priced models have no pass rate anywhere we could find.** Sonnet 5 and
