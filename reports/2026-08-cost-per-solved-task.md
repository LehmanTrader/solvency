...
**Not in either table:** the remaining 297 priced, current models in the catalog — which,
...
Grok 4.6, and hundreds more. None has a published pass rate we could find. They are
missing, not zero.
...
- **297 of 387 current, priced models have no pass rate anywhere we could find.** Sonnet 5 and
